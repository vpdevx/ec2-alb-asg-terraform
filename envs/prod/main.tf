...
module "auto_scalling_group" {
    ...
    asg_policies = [
        {
        name = "prod-asg-policy-scale-up"
        scaling_adjustment = 1
        adjustment_type = "ChangeInCapacity"
        cooldown = 300
        },
        {
        name = "prod-asg-policy-scale-down"
        scaling_adjustment = -1
        adjustment_type = "ChangeInCapacity"
        cooldown = 300
        }
...
module "cloudwatch_scale_up_alarm" {
  ...
  cloudwatch_alarm_name = "prod-alarm-scale-up"
...
module "cloudwatch_scale_down_alarm" {
  source = "../../modules/cloudwatch"
  cloudwatch_alarm_name = "prod-alarm-scale-down"
  cloudwatch_alarm_description = "This metric monitors the CPU utilization of the EC2 instances"
